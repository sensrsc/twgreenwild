...
class CarReserveOrder extends Model
{
    ...
    protected $fillable = ['cro_type', 'cro_city', 'cro_district', 'cro_address', 'cro_car_model', 'cro_way', 'cro_adult', 'cro_children', 'cro_detail', 'cro_est_fee', 'cro_name', 'cro_telno', 'cro_email'];
}
