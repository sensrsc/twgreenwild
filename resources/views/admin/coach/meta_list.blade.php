...
<div class="col-md-12 portlet light">    
    ...
    <div class="portlet light portlet-fit ">
        <div class="actions">
            <a class="dt-button buttons-print btn dark btn-outline" tabindex="0" href="/admin/coach">
                <span>返回教練管理</span>
            </a>
        </div>
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i>{{ $coach->c_name }} 教練 {{ config('common.coach_meta_types')[$type] }} 列表
            </div>
            <div class="actions">
                <a class="dt-button buttons-print btn dark btn-outline" tabindex="0" href="/admin/coachmeta/add/{{ $type }}/{{ $coach->c_id }}">
                    <span>新增{{ config('common.coach_meta_types')[$type] }}</span>
                </a>
            </div>
        </div>
                        ...
                        <tbody>
                            @if (!empty($lists))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/coachmeta/detail/{{ $list->cm_id }}" class="btn btn-outline btn-circle btn-sm blue">
                                            <i class="fa fa-edit">查看/編輯</i></a>
                                        <a href="#" data-id="{{ $list->cm_id }}" class="btn btn-outline btn-circle btn-sm red del_btn" data-toggle="modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="post" id="modal_form" class="form-horizontal" role="form">
                    {{ csrf_field() }}
                    <input type="hidden" name="c_id" id="c_id" value="{{ $coach->c_id }}">
...
@section('js_script')
    <script src="/assets/apps/scripts/admin/coach_meta_list.js"></script>
@endsection