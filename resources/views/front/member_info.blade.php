...
<div class="container member-info" style="text-align: center;">
<form class="bd-example" method="post">
	...
	<p>登入資料</p>
	<p class="row">
		<span class="col-4 col-md-5">姓名</span>
		<input type="text" name="name" value="{{ $user->u_name }}">
	</p>
	<p class="row">
		<span class="col-4 col-md-5">身分證號碼</span>
		<input type="text" name="identity" value="{{ $user->u_identity }}">
		<p>*非台灣客戶請輸入身份識別碼</p>
	</p>
	<p class="row">
		<span class="col-4 col-md-5">性別</span>
	...
	<p class="row">
		<span class="col-4 col-md-5">生日</span>
		<select name="year" id="">
	...
	<p class="row">
		<span class="col-4 col-md-5">身高</span>
		<input type="text" name="height" value="{{ $user->u_height }}">
		<span class="col-4 col-md-5">公分</span>
	</p>
	<p class="row">
		<span class="col-4 col-md-5">體重</span>
		<input type="text" name="weight" value="{{ $user->u_weight }}">
		<span class="col-4 col-md-5">公斤</span>
	</p>
	<p class="row">
		<span class="col-4 col-md-5">腳掌</span>
		<input type="text" name="foot" value="{{ $user->u_foot }}">
		<span class="col-4 col-md-5">公分</span>
	</p>
	<p class="row">
		<span class="col-4 col-md-5">電話</span>
		<input type="tel" name="phone" value="{{ $user->u_phone }}">
	</p>
	<p class="row">
		<span class="col-4 col-md-5">地址</span>
		<input type="text" name="address" value="{{ $user->u_address }}">
	</p>
	<!-- <p class="row">
		<span class="col-4 col-md-5">信箱</span>
		<input type="mail">
	</p> -->
	<p>緊急聯絡人資料</p>
	<p class="row">
